...
if ( ! class_exists( 'Medical_Circle_Posts_Col' ) ) {
    ...
    class Medical_Circle_Posts_Col extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'medical_circle_cat_id' ) ); ?>"><?php _e('Select Category', 'medical-circle'); ?></label>
                <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'post_number' ) ); ?>"><?php _e( 'Post Number', 'medical-circle' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>"><?php _e( 'Column Number', 'medical-circle' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><?php _e( 'Extra Button Text', 'medical-circle' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_url' ) ); ?>"><?php _e( 'Button Link Url', 'medical-circle' ); ?>:</label>
