...
if ( ! class_exists( 'Medical_Circle_Contact' ) ) {
    ...
    class Medical_Circle_Contact extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php _e( 'Enter Shortcode', 'medical-circle' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Page For Contact', 'medical-circle' ); ?>:</label>
                <br />
