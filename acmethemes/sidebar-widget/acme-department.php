...
if ( ! class_exists( 'Medical_Circle_Department' ) ) {
    ...
    class Medical_Circle_Department extends WP_Widget {
        ...
        public function form( $instance ) {
	        ...
	        ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'unique_id' ) ); ?>"><?php _e( 'Section ID', 'medical-circle' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title', 'medical-circle' ); ?>:</label>
            ...
            <!--updated code-->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_text' ) ); ?>"><?php _e( 'Read More Text', 'medical-circle' ); ?>:</label>
            ...
            <p>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'enable_appointment' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'enable_appointment' ) ); ?>" value="1" type="checkbox" <?php checked(true, $enable_appointment, true)?> />
                <label for="<?php echo esc_attr( $this->get_field_id( 'enable_appointment' ) ); ?>"><?php _e( 'Enable Appointment Button', 'medical-circle' ); ?>:</label>

            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'appointment_text' ) ); ?>"><?php _e( 'Appointment Text', 'medical-circle' ); ?>:</label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'appointment_text' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'appointment_text' ) ); ?>" type="text" value="<?php echo $appointment_text; ?>" />
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'background_options' ) ); ?>"><?php _e( 'Background Options', 'medical-circle' ); ?>:</label>
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="at-widgets at-department <?php echo esc_attr( $bg_gray_class ); ?>">
                <div class="container">
                        ...
                        if( !empty( $post_in ) ):
                            ...
                            if ( $department_query->have_posts() ):
	                            ...
	                            while( $department_query->have_posts() ):$department_query->the_post();
	                                $active = ( $i == 0?'active':'');
                                    ?>
                                    <div class="department-title <?php echo esc_attr( $active ); ?>">
	                            ...
	                            while( $department_query->have_posts() ):$department_query->the_post();
                                    ...
                                    <div class="department-item-content <?php echo $active;?>" data-id="atdp-<?php echo esc_attr( get_the_ID() );?>">
                                        <div class="content-wrapper row">
		                                    ...
		                                    ?>
                                            <div class="<?php echo esc_attr( $no_blog_image ); ?>">
